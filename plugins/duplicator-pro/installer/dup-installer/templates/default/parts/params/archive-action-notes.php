...
?>
<div class="archive-action-note archive-action-<?php echo DUP_PRO_Extraction::ACTION_DO_NOTHING.($currentAction == DUP_PRO_Extraction::ACTION_DO_NOTHING ? '' : ' no-display'); ?>">
...
<div class="archive-action-note archive-action-<?php echo DUP_PRO_Extraction::ACTION_REMOVE_ALL_FILES.($currentAction == DUP_PRO_Extraction::ACTION_REMOVE_ALL_FILES ? '' : ' no-display'); ?>">
...
<div class="archive-action-note archive-action-<?php echo DUP_PRO_Extraction::ACTION_REMOVE_WP_FILES.($currentAction == DUP_PRO_Extraction::ACTION_REMOVE_WP_FILES ? '' : ' no-display'); ?>">
