...
$admin_redirect = (DUPX_MU::newSiteIsMultisite() ? "{$site_url}/wp-admin/network/admin.php?page=duplicator-pro-tools&tab=d" : "{$site_url}/wp-admin/admin.php?page=duplicator-pro-tools&tab=d");
