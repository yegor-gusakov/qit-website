...
<div id="scan-unreadable-items" class="scan-item">
    <div class='title' onclick="DupPro.Pack.toggleScanItem(this);">
        ...
        <div id="data-arc-status-network-filtered-sites"></div>
    </div>
    <div class="info">
            ...
            <div class="container">
                <div class="data">
					{{#if ARC.Status.HasFilteredSites}}
                        <p class="red">
                            <?php
                            DUP_PRO_U::esc_html_e("Some Sites have been excluded from the network, with this package it will not be possible to restore the network but only perform standalone migrations.");
                            ?>
                        </p>
                        <b><?php DUP_PRO_U::esc_html_e('Filtered sites'); ?></b>
                        <ol>
        ...
        <script id="hb-migrate-package-result" type="text/x-handlebars-template">
            <div class="container">
                <div class="data">
                    ...
                    {{#ifAllOr ARC.Status.IsDBOnly ARC.Status.HasFilteredCoreFolders ARC.Status.HasFilteredSiteTables}}
                        <hr>
                        <p>
                            <span style="color: red;">
...
jQuery(document).ready(function($)
{
	...
	DupPro.Pack.initArchiveFilesData = function(data)
	{
        ...
        $('#data-arc-status-network-filtered-sites').html(DupPro.Pack.setScanStatus((data.ARC.Status.HasFilteredSites ? 'Warn' : 'Good')));
