...
$show_rekki_tags = !empty($options['show_rekki_tags']);
$show_rekki_min_read = !empty($options['show_rekki_min_read']);
...
if ($options['layout'] == 'rekki-two') {
	include __DIR__ . '/layout-rekki-two.php';
} else {
	include __DIR__ . '/layout-rekki-one.php';
