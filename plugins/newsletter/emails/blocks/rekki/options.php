...
$fields->select('layout', __('Layout', 'newsletter'),
        [
            'rekki-one' => __('ReKKi one post', 'newsletter'),
            'rekki-two' => __('ReKKi two posts', 'newsletter'),
])
?>
...
<div class="tnp-field-row">
    ...
    </div><div class="tnp-field-col-3">
        <?php $fields->checkbox('show_rekki_tags', __('Show tags', 'newsletter')) ?>
    </div><div class="tnp-field-col-3">
        <?php $fields->checkbox('show_rekki_min_read', __('Show minutes read', 'newsletter')) ?>
    </div>
    <div style="clear: both"></div>
</div>
