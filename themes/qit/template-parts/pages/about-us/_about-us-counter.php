...
<section class="section__counter section" id="metrics">
    <div class="container ">
		<?php if ( $badge ): ?>
		...
		<?php if ( $counter_repeater ):?>
            <div class="section__counter-row row text-center">
				<?php foreach ( $counter_repeater as $counter ) :$count_number = $counter['count_number'];$count_text = $counter['count_text'] ?>
                    <div class="col-lg-4 col-12 col-sm-6 section__counter-row-count">
