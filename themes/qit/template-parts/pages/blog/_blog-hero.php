 ...
 * Fields
 */
$field       = get_query_var( 'blog_field' );
            ...
            <div class="col-lg-8 col-sm-11">
				...
				<?php if ( $button ): ?>
                    <div class="section__hero-row-button">
                        <button class="button btn-outline subscribe-modal" type="button"><?= $button['title'] ?></button>
                    </div>
				<?php endif ?>
            </div>
        </div>
        <div class="section__hero-row row justify-content-center">
            <div class="col-auto">
                <div class="section__hero-mousescroller position-absolute bottom-25">
                    <a href="#posts"><?= file_get_contents( $mousescroll ) ?></a>
                </div>
            </div>
        </div>
    </div>
