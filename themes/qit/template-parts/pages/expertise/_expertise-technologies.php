		...
		<?php if ( $directions ): ?>
            <div class="section__technologies-row row">
                ...
                <ul class="section__technologies-nav nav nav-tabs border-0 flex-nowrap" id="technologiesDirection" role="tablist">
					<?php
					foreach ( $directions as $key => $direction ):switch ( $key ):case "web":?>
                                <li class="section__technologies-nav-item nav-item" role="presentation">
                                    <button class="section__technologies-nav-link nav-link active text-uppercase" id="<?= $key ?>-tab" data-bs-toggle="tab" data-bs-target="#<?= $key ?>-tab-pane" type="button" role="tab" aria-controls="<?= $key ?>-tab-pane" aria-selected="true"><?= $key ?></button>
                                </li>
								<?php
								break;
							case "mobile":?>
                                <li class="section__technologies-nav-item nav-item" role="presentation">
                                    <button class="section__technologies-nav-link nav-link text-uppercase" id="<?= $key ?>-tab" data-bs-toggle="tab" data-bs-target="#<?= $key ?>-tab-pane" type="button" role="tab" aria-controls="<?= $key ?>-tab-pane" aria-selected="true"><?= $key ?></button>
                                </li>
								<?php break;
							case "desktop":?>
                                <li class="section__technologies-nav-item nav-item" role="presentation">
						...
						switch ( $key ):case "web":?>
                                <div class="tab-pane fade show active" id="<?= $key ?>-tab-pane" role="tabpanel" aria-labelledby="<?= $key ?>-tab" tabindex="0">
                                    <div class="row align-items-stretch">
										<?php foreach ( $direction as $lang ):get_template_part( 'template-parts/parts/technologies/technologies', null, array( 'id' => $lang ) );endforeach; ?>
                                    </div>
                                </div>
								<?php
								break;
							case "mobile":?>
                                <div class="tab-pane fade" id="<?= $key ?>-tab-pane" role="tabpanel" aria-labelledby="<?= $key ?>-tab" tabindex="0">
                                    <div class="row align-items-stretch">
										<?php foreach ( $direction as $lang ):get_template_part( 'template-parts/parts/technologies/technologies', null, array( 'id' => $lang ) );endforeach; ?>
                                    </div>
                                </div>
