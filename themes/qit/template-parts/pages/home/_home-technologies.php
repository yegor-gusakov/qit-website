...
<section class="section section__technologies">
    <div class="container">
        <div class="section__technologies-row row justify-content-center"><h6
                    class="section__technologies-row-badge m-0 w-auto text-white text-uppercase"><?= $badge ?></h6>
        </div>
            ...
            <div class="section__technologies-tab tab-content p-sm-0"
				...
				foreach ( $directions as $key => $direction ):
					switch ( $key ):
						...
						case "mobile":
							?>
                            <div class="tab-pane fade" id="<?= $key ?>-tab-pane"
                                 role="tabpanel"
                                 aria-labelledby="<?= $key ?>-tab" tabindex="0">
                                <div class="row align-items-stretch">
