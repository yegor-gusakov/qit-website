            ...
            <div class="col-md-7">
                ...
                <div class="card mb-3 border-0 bg-transparent" style="max-width: 540px;">
                    <div class="row g-0 align-items-center mb-3">
                        <div class="col-md-4 section__banner-yegor-comment-img rounded-circle bg-white">
                            <img src="<?= $comment_image['url'] ?>"
                                 class="img-fluid rounded-circle" alt="<?=$yegor_right_image['alt']?>">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body px-3">
                                <h6 class="card-title m-0 text-white"><?= $comment_name ?></h6>
                                <p class="card-text"><small><?= $comment_position ?></small>
                                </p>
                            </div>
                        </div>
                    </div>
